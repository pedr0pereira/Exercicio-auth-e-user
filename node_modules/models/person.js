...
const { acessosVasculares } = require('./VascularAcess');
...
const VascularAcess = require('./VascularAcess').VascularAcess;
...
Person.belongsToMany(VascularAcess, {
  through: 'acessosVascularesPerson',
  foreignKey: 'personId',
  otherKey: 'acessosVascularesId',
  timestamps: false,
});
